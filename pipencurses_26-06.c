...
void infoWin(Reg *reg, Decod *decod, Inst *inst) {
  ...
  printAssemblyNcurses(infowin2, l2++, 3, reg->id_ex.instID_EX, decod);
	...
	mvwprintw(infowin2, l2++, 3, "escreg ----- %d\n", reg->id_ex.escreg);
	
	mvwprintw(infowin2, l2++, 3, "escmem ----- %d\n", reg->id_ex.escmem);
	...
	mvwprintw(infowin2, l2++, 3, "ulafonte --- %d\n", reg->id_ex.ulafonte);
  ...
  printAssemblyNcurses(infowin3, l3++, 3, reg->ex_mem.instEX_MEM, decod);
	...
	mvwprintw(infowin3, l3++, 3, "escreg ----- %d\n", reg->ex_mem.escreg);
	
	mvwprintw(infowin3, l3++, 3, "escmem ----- %d\n", reg->ex_mem.escmem);
	
	mvwprintw(infowin3, l3++, 3, "saidaula --- %d", reg->ex_mem.saidaula);
	mvwprintw(infowin3, l3++, 3, "b ---------- %d\n", reg->ex_mem.b);
  ...
  printAssemblyNcurses(infowin4, l4++, 3, reg->mem_wb.instMEM_WB, decod);
	...
	mvwprintw(infowin4, l4++, 3, "escreg ----- %d\n", reg->mem_wb.escreg);
	
	mvwprintw(infowin4, l4++, 3, "dadomem ---- %d", reg->mem_wb.dadomem);
	mvwprintw(infowin4, l4++, 3, "saidaula --- %d\n", reg->mem_wb.saidaula);
